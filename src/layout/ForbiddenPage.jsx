    ...
    <div className="min-h-screen
     ...
     flex flex-col items-center justify-center p-4 text-white overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl">
        {/* Número 403 oco com contorno */}
        <div className="relative -top-8">
          <h1 className="text-[15rem] md:text-[25rem] font-bold text-transparent opacity-90" style={{
        ...
        <h2 className="text-3xl md:text-5xl font-bold mb-6 mt-[-80px] md:mt-[-140px] relative">
          Acesso Negado!
          <div className="absolute bottom-[-10px] left-1/2 transform -translate-x-1/2 h-1 w-24 bg-accent rounded-full"></div>
        </h2>
        
        <p className="text-lg md:text-xl mb-10 max-w-md mx-auto">
          Parece que você está tentando acessar uma tela ou funcionalidade para a qual não possui as credenciais necessárias.
        </p>
      ...
      <style jsx>{`
        ...
        .animate-float-delay-1 { animation: float 7s ease-in-out 1s infinite; }
        .animate-float-delay-2 { animation: float 5s ease-in-out 2s infinite; }
