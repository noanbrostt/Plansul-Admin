import{r as m,j as t}from"./index-CaMTW5gI.js";const T=m.forwardRef(({placeholder:p="",value:r="",onChange:x,variant:N,size:n="md",largura:f="w-64",maxLength:e,showCounter:c=!0,className:u="",error:a,success:s,info:l,fieldset:j=!1,asterisk:o=!1},h)=>{const[b,$]=m.useState(r.length);m.useEffect(()=>{$(r.length)},[r]);const y=E=>{const i=E.target.value;e!=null&&i.length>e||(x==null||x(i),$(i.length))};let d=t.jsxs("div",{className:`form-control ${f} ${u}`,children:[t.jsx("textarea",{ref:h,className:`
            textarea resize
            textarea-${n}
            textarea-${N}
            ${f}
